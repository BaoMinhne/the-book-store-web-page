                    ...
                    <div class="header-with-search">
                        ...
                        <div class="header__task">
                            <ul class="header__task-list">
                                <li class="header__task-item"><a href="<?= asset_url('controller/viewProduct.php'); ?>" class="header__task-link">Xem Sản Phẩm</a></li>
                                <li class="header__task-item"><a href="<?= asset_url('controller/addProduct.php'); ?>" class="header__task-link">Thêm Sản Phẩm</a></li>
                                <li class="header__task-item"><a href="<?= asset_url('controller/upProduct.php'); ?>" class="header__task-link">Cập nhật Sản Phẩm</a></li>
                                <li class="header__task-item"><a href="<?= asset_url('controller/delProduct.php'); ?>" class="header__task-link">Xoá Sản Phẩm</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
